...
export const WandIcon: React.FC = () => (
    <svg className="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 00-3.48-2.14-3 3 0 00-2.43 2.14 3 3 0 001.03 3.48 3 3 0 003.48 1.03 3 3 0 002.14-2.43 3 3 0 00-1.03-3.48zM9.53 16.122l4.47-4.47M9.53 16.122l-2.14-2.14M6 20.25h.008v.008H6v-.008zM18.75 5.25h.008v.008h-.008v-.008zM16.5 9.75h.008v.008h-.008V9.75zM12 3.75h.008v.008H12V3.75z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 12.75a3 3 0 003 3h3a3 3 0 003-3 3 3 0 00-3-3h-3a3 3 0 00-3 3z" />
    </svg>
);
...
export const ShuffleIcon: React.FC<{ className?: string }> = ({ className = 'w-5 h-5' }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0011.667 0l3.181-3.183m-11.667 0a8.25 8.25 0 0111.667 0l3.181 3.183M2.985 19.644A8.25 8.25 0 0114.652 8.02l3.181-3.182m0 0h-4.992m4.992 0v4.992" />
    </svg>
);

export const ZoomIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
